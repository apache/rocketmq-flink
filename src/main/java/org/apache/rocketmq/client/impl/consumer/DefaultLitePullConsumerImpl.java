...
public class DefaultLitePullConsumerImpl implements MQConsumerInner {
    ...
    private ConcurrentHashMap<String /* topic */, String /* subExpression */> topicToSubExpression =
    ...
    private final BlockingQueue<ConsumeRequest> consumeRequestCache =
            new LinkedBlockingQueue<ConsumeRequest>();

    private ScheduledThreadPoolExecutor scheduledThreadPoolExecutor;

    private final ScheduledExecutorService scheduledExecutorService;

    private Map<String, TopicMessageQueueChangeListener> topicMessageQueueChangeListenerMap =
            new HashMap<String, TopicMessageQueueChangeListener>();

    private Map<String, Set<MessageQueue>> messageQueuesForTopic =
            new HashMap<String, Set<MessageQueue>>();
    ...
    class MessageQueueListenerImpl implements MessageQueueListener {
        ...
        public void messageQueueChanged(
                String topic, Set<MessageQueue> mqAll, Set<MessageQueue> mqDivided) {
    ...
    private synchronized void fetchTopicMessageQueuesAndCompare() throws MQClientException {
        for (Map.Entry<String, TopicMessageQueueChangeListener> entry :
    ...
    public class ConsumeRequest {
        ...
        public ConsumeRequest(
                final List<MessageExt> messageExts,
