...
public interface LitePullConsumer {
     ...
     *
     * <p>Because of the implementation of pre-pull, fetch data in {@link #poll()} will not stop
     * immediately until the messages of the requested message queues drain.
     *
     * <p>Note that this method does not affect message queue subscription. In particular, it does
