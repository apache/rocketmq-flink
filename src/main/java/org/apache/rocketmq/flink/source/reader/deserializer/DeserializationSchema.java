...
public interface DeserializationSchema<IN, OUT> extends Serializable, ResultTypeQueryable<OUT> {
    ...
    /**
     * Initialization method for the schema. It is called before the actual working methods {@link #deserialize} and
     * thus suitable for one time setup work.
     *
     ...
     * the produced records should be relatively small. Depending on the source implementation records can be buffered
     * in memory or collecting records might delay emitting checkpoint barrier.
     *
