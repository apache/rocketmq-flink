...
public class RocketMQWriterStateSerializer
        implements SimpleVersionedSerializer<RocketMQWriterState> {
    @Override
    ...
    public RocketMQWriterState deserialize(int version, byte[] serialized) throws IOException {
        try (final ByteArrayInputStream bais = new ByteArrayInputStream(serialized);
            ...
            final String producerGroup = in.readUTF();
            return new RocketMQWriterState(producerGroup);
        }
    }
}
