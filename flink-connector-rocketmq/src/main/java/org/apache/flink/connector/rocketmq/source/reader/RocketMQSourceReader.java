...
public class RocketMQSourceReader<T>
    ...
    private void handleSourceCheckEvent(SourceCheckEvent sourceEvent) {
        ...
        Set<MessageQueue> increaseSet = new HashSet<>(assignedMq);
        increaseSet.removeAll(currentMq);
        Set<MessageQueue> decreaseSet = new HashSet<>(currentMq);
        decreaseSet.removeAll(assignedMq);
